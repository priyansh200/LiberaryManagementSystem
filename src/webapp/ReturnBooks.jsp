	...
	<div class="screen">
		<div class="screen__content">
			...
			<form class="login">
				...
				<input class="button login__submit" type ="submit" value="Return this book">
...
<%
	...
	PreparedStatement ps = connection.prepareStatement("insert into avaliblbooks (BookName , Author)values (?,?)");
